...
import { PLAYERS_BY_TEAM_QUERY, COACHING_STAFF_QUERY } from "@/sanity/lib/queries";
                ...
                {players.length === 0 ? (
                  ...
                  <>
                    {activeCategory === "goalkeepers" && (
                      <div id="goalkeepers">
                        <h3 className="text-3xl font-bold uppercase text-gray-900 mb-8">
                          Goalkeepers
                        </h3>
