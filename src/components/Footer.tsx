      ...
      <div className="container mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="flex justify-center items-center gap-6">
            ...
            <Twitter className="w-8 h-8 text-white hover:text-barca-gold transition-colors cursor-pointer" />
            ...
            <Music className="w-8 h-8 text-white hover:text-barca-gold transition-colors cursor-pointer" />
            <div className="w-8 h-8 rounded-full bg-white text-[#1a1a2e] flex items-center justify-center font-bold text-sm">
              B
            </div>
            {/* TikTok Icon */}
