  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <button
          onClick={() =>
            currentStoryIndex > 0 && goToStory(currentStoryIndex - 1)
          }
        ...
        >
          ...
          <div className="absolute top-6 left-0 right-0 z-30 px-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-parofc-blue to-parofc-red flex items-center justify-center overflow-hidden">
                {currentStory.coverImage ? (
                  <Image
                    src={urlFor(currentStory.coverImage)
                      .width(40)
                      .height(40)
                      .url()}
              ...
              <div>
                ...
                {currentStory.isNew && (
                  <span className="text-xs text-parofc-gold">New</span>
                )}
              </div>
            </div>
          ...
          >
            ...
            <button
              ...
              className={`w-10 h-10 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center transition-all pointer-events-auto ${
                hasPrevMedia
                  ? "opacity-100 hover:bg-black/60 cursor-pointer"
                  : "opacity-0 pointer-events-none"
              }`}
          ...
          {/* Swipe hint */}
          <div
            className={`absolute bottom-24 left-1/2 -translate-x-1/2 z-30 transition-opacity duration-500 ${showControls ? "opacity-100" : "opacity-0"}`}
          >
          ...
          {stories.map((story, index) => (
            ...
            >
              {story.coverImage ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-parofc-blue to-parofc-red" />
              )}
            </button>
          ))}
        </div>
