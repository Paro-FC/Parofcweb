              ...
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center px-5">
                  ...
                  <Link
                    href="/shop"
                    onClick={() => setIsCartOpen(false)}
                    className="bg-barca-red text-white px-5 py-2.5 font-bold text-xs uppercase tracking-wider hover:bg-barca-red/80 transition-colors cursor-pointer"
                  >
                    Browse Shop
                  </Link>
                </div>
                  ...
                  {items.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 flex flex-col">
                        ...
                        <p className="text-xs font-bold text-barca-gold mt-1">
                        ...
                        <div className="flex items-center justify-between mt-auto pt-2">
                          ...
                          <button
                            ...
                            className="text-white/20 hover:text-barca-red transition-colors cursor-pointer"
            ...
            {items.length > 0 && (
              <div className="border-t border-white/5 px-5 py-5 space-y-4">
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  <span className="text-lg font-black text-barca-gold tabular-nums">
                ...
                <Link
                  href="/checkout"
                  onClick={() => setIsCartOpen(false)}
                  className="w-full h-12 bg-barca-red text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-barca-red/80 transition-colors cursor-pointer"
                >
                  Checkout
                  <ArrowRight size={14} />
                </Link>
