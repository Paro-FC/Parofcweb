          ...
          {article.externalUrl ? (
            <div className="mt-8">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-md bg-parofc-red px-6 py-3 text-sm font-black uppercase tracking-wider text-white transition hover:bg-parofc-red/80"
              >
                Read Full Article
                <HugeiconsIcon icon={ArrowUpRight01Icon} size={16} primaryColor="currentColor" strokeWidth={2} />
              </a>
            </div>
          ) : (
            <>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-8">
              {relatedNews.map((news, index) => (
                ...
                >
                  <Link
                    href={news.externalUrl ?? `/news/${news.slug}`}
                    {...(news.externalUrl ? { target: "_blank", rel: "noopener noreferrer" } : {})}
